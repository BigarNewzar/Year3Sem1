...
def main():
    ...
    if (str(All).lower() == "generic"):
       ...
       # print (All, " Testcase:", TestCaseType, " FileCount:",FileCount, " TotalPrepositionSymbolCount:",TotalPrepositionSymbolCount, " TotalSingleHornedClauseCount:",TotalSingleHornedClauseCount, " TotalConjuectionHornedClauseCount:",TotalConjuectionHornedClauseCount, " TotalMultiConjuctionHornedClauseCount:", TotalMultiConjuctionHornedClauseCount)
        print("All files have been made! Press Enter to exit1")
"""
