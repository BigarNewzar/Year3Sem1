...
def main():
    ...
    if not os.path.exists(parser_file):
        print("[ERROR] Can't find plparser file {}!".format(lexer_file))
        print(os.path.realpath(''))
        exit(1)
    ...
    def process(input_stream, class_lexer, class_parser):
        ...
        #plparser.setTokenStream(token_stream)
        ...
        if hasattr(parser, start_rule):
            ...
            print("[ERROR] Can't find start rule '{}' in plparser '{}'".format(start_rule, parserName))
