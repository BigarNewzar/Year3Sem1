...
class PredictionMode(Enum):
    ...
    # plparser context when making predictions. This is the fastest prediction
    ...
    #
    # <p>
    # When using this prediction mode, the plparser will either return a correct
    ...
    SLL = 0
    #
    # The LL(*) prediction mode. This prediction mode allows the current plparser
    ...
    #
    # <p>
    # When using this prediction mode, the plparser will make correct decisions
