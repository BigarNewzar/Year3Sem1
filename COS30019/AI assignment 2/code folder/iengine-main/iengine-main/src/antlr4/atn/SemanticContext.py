...
class SemanticContext(object):
    ...
    # opposed to the plparser, which creates them naturally). In a practical
    ...
    #
    # @param plparser The plparser instance.
    # @param outerContext The current plparser context object.
