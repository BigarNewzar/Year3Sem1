...
#  mismatched input errors. In each case, the plparser knows where it is
...
class RecognitionException(Exception):
    ...
    def __init__(self, message:str=None, recognizer:Recognizer=None, input:InputStream=None, ctx:ParserRulecontext=None):
        ...
        # Get the ATN state number the plparser was in at the time the error
...
# Indicates that the plparser could not decide which of two or more paths
#  to take based upon the remaining input. It tracks the starting token
#  of the offending input and also knows where the plparser was
