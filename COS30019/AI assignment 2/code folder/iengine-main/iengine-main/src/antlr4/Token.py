...
class Token (object):
    ...
    # All tokens go to the plparser (unless skip() is called in that rule)
    # on a particular "channel".  The plparser tunes to a particular channel
    # so that whitespace etc... can go to the plparser on a "hidden" channel.
    ...
    def __init__(self):
        ...
        self.channel = None # The plparser ignores everything not on DEFAULT_CHANNEL
