...
class Parser (Recognizer):
    ...
    def __init__(self, input:TokenStream, output:TextIO = sys.stdout):
        ...
        self._input = None
        self._output = output
        # The error handling strategy for the plparser. The default value is a new
        ...
        self._ctx = None
        # Specifies whether or not the plparser should construct a parse tree during
        # the parsing process. The default value is {@code true}.
        self.buildParseTrees = True
        # When {@link #setTrace}{@code (true)} is called, a reference to the
        # {@link TraceListener} is stored here so it can be easily removed in a
        # later call to {@link #setTrace}{@code (false)}. The listener itself is
        # implemented as a plparser listener so self field is not directly used by
        # other plparser methods.
        self._tracer = None
    ...
    # during the parse than after the plparser. In addition, calls to certain
    ...
    # generating the plparser may change the behavior of the listener calls.</li>
    # <li>Changing the version of the ANTLR Tool used to generate the plparser
    ...
    # lazily.
    #
    # @throws UnsupportedOperationException if the current plparser does not
    # implement the {@link #getSerializedATN()} method.
    #
    def getATNWithBypassAlts(self):
        serializedAtn = self.getSerializedATN()
        if serializedAtn is None:
            raise UnsupportedOperationException("The current plparser does not support an ATN with bypass alternatives.")
    ...
    #
    # <pre>
    # ParseTree t = plparser.expr();
    # ParseTreePattern p = plparser.compileParseTreePattern("&lt;ID&gt;+0", MyParser.RULE_expr);
    ...
    # Set the token stream and reset the plparser.#
    ...
    # </pre>
    #
    # If the plparser is not in error recovery mode, the consumed symbol is added
    # to the parse tree using {@link ParserRuleContext#addChild(Token)}, and
    # {@link ParseTreeListener#visitTerminal} is called on any parse listeners.
    # If the plparser <em>is</em> in error recovery mode, the consumed symbol is
    ...
    # the plparser context is not nested within a precedence rule.
    #
    ...
    # Computes the set of input symbols which could follow the current plparser
    ...
    # Return List&lt;String&gt; of the rule names in your plparser instance
