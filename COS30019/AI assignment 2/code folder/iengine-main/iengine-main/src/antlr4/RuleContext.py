...
class RuleContext(RuleNode):
   ...
   #  public Future<JDialog> inspect(@Nullable Parser plparser) {
   #      List<String> ruleNames = plparser != null ? Arrays.asList(plparser.getRuleNames()) : null;
   ...
   #  public void save(@Nullable Parser plparser, String fileName)
