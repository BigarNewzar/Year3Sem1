...
class PLAgent:
    def __init__(self, stream):
        ...
        self.__methods = {'ttentail': ttenum.tt_entail, 'fc': fc.fc_entail, 'bc': bc.bc_entail}
    ...
    def interpret(self, method):
        if method not in self.__methods.keys():
            print('No method with matching codename found, resorting to truth table enumeration.')
            method = 'ttentail'
        else:
